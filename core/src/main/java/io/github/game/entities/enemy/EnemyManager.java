...
public class EnemyManager {
    ...
    public EnemyManager(TextureAtlas spriteAtlas) {
        ...
        enemies.add(new Enemy("professor", new DialogueInteraction(0, true, true), (Main.WORLD_WIDTH / 8f ) * 7, Main.WORLD_HEIGHT / 3f,
            16, 16, -1,100, spriteAtlas));
        enemies.add(new Enemy("comp_student", new DialogueInteraction(0, false, true), (Main.WORLD_WIDTH / 8f ) * 5, ((Main.WORLD_HEIGHT / 8f) * 5) - 16,
            16, 16, 0,0, spriteAtlas));
        enemies.add(new Enemy("child", new TakeItemInteraction("keycard", 0,0, true, true), 48, Main.WORLD_HEIGHT - (96 * 2),
            16, 16, 16,200, spriteAtlas));
    }
